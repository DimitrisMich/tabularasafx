 ...
 */
public class CreateStudentController extends StageController{
    private TransitionService service;
    private final URL fxmlURL;
    private final ResourceBundle resources;
    
    public CreateStudentController(URL fxml, ResourceBundle res) {
        super();
        fxmlURL = fxml;
        resources = res;
    }
...
//        mainTitle.setText(labels.getString("new.student.create"));
